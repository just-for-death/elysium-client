...
class ElysiumApp extends ConsumerWidget {
  const ElysiumApp({super.key});
    ...
    return DynamicColorBuilder(
      builder: (ColorScheme? lightDynamic, ColorScheme? darkDynamic) {
        ...
        return MaterialApp.router(
          ...
          routerConfig: router,
          scrollBehavior: _ElysiumScrollBehavior(),
        );
      },
    );
  }
...
// Allow touch AND mouse scrolling everywhere
class _ElysiumScrollBehavior extends MaterialScrollBehavior {
  @override
